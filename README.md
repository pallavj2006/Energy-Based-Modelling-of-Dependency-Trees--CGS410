...
Here are the analytical plots generated by `analysis.py`. **Click on any image to open the full-resolution file.**

### 1. Dependency Length Comparison
[![Dependency Length Comparison](./figures/fig1_dl_comparison.png)](./figures/fig1_dl_comparison.png)

### 2. Dependency Length by Sentence Length
[![Dependency Length by Length](./figures/fig2_dl_by_length.png)](./figures/fig2_dl_by_length.png)

### 3. Intervener Complexity Comparison
[![Intervener Complexity Comparison](./figures/fig3_ic_comparison.png)](./figures/fig3_ic_comparison.png)

### 4. Dependency Length Reduction
[![Dependency Length Reduction](./figures/fig4_dl_reduction.png)](./figures/fig4_dl_reduction.png)

### 5. Energy Model Fit
[![Energy Model](./figures/fig5_energy_model.png)](./figures/fig5_energy_model.png)

### 6. Beta Estimates by Language
[![Beta Estimates](./figures/fig6_beta_estimates.png)](./figures/fig6_beta_estimates.png)
